...
var RTCEncoder = function(id,codec,params)
{
	//Create private data
	var private = {
		id		: id,
	...
	if (params)
		...
		private.encodings["default"] = new RTCEncoding("default",this,null,params);
 ...
 */
RTCEncoderFactory.prototype.create = function(codec,params)
{
	return new RTCEncoder(maxId++,codec,params);
};
