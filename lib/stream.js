...
var RTCRtpStream = function(params)
{
	//Private data
	var private = {
		muxId : undefined
...
RTCRtpStream.prototype.addPayload = function(type,payload)
{
	//Get private data
...
RTCRtpStream.prototype.deletePayload = function(type)
{
	//Get private data
	var private = privates.get(this);
...
RTCRtpStream.prototype.attach = function(transport)
{
	//Get private data
	var private = privates.get(this);
...
RTCRtpStream.prototype.dettach = function()
{
	//Get private data
	var private = privates.get(this);
